...
export default function RecentInvestigations({
  ...
  return (
    <Section
      ...
      description="Source-grounded investigations ready to explore, each sourced from persisted backend workspaces with narrative context, timeline, and receipts."
      className="pt-16"
    >
      {errorMessage ? (
        <StateCard
